...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="bg-surface-container-lowest p-3 lg:p-4 rounded-xl standard-shadow">
      <div
    ...
    <section className="py-32 bg-surface-container-low">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="order-2 lg:order-1 lg:sticky lg:top-24 self-start pb-8 lg:pb-0">
          <img alt="Professional physiotherapist assisting a patient" className="rounded-xl standard-shadow mx-auto w-5/6 lg:w-[75%] aspect-[3/4] lg:aspect-auto lg:h-[85vh] object-cover" src="/images/exercise.webp" />
        </div>
